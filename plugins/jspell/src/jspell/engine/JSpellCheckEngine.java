 ...
 * @since 3.0
 */
public class JSpellCheckEngine implements ISpellCheckEngine, IPropertyChangeListener {
	...
	/*
	 * @see
	 * org.eclipse.jdt.internal.ui.text.spelling.engine.ISpellCheckEngine#findDictionary(java.util
	 * .Locale)
	 * 
	 * @since 3.3
	 */
	...
	public static synchronized final ISpellCheckEngine getInstance() {
		...
		if (fgEngine == null) {
			fgEngine = new JSpellCheckEngine();
		}
	...
	public static Locale convertToLocale(String locale) {
		Locale defaultLocale = JSpellCheckEngine.getDefaultLocale();
	...
	/*
	 * @see
	 * org.eclipse.jdt.internal.ui.text.spelling.engine.ISpellCheckEngine#registerDictionary(org
	 * .eclipse.jdt.internal.ui.text.spelling.engine.ISpellDictionary)
	 */
	@Override
	...
	/*
	 * @see
	 * org.eclipse.jdt.internal.ui.text.spelling.engine.ISpellCheckEngine#registerDictionary(java
	 * .util.Locale, org.eclipse.jdt.internal.ui.text.spelling.engine.ISpellDictionary)
	 */
	@Override
